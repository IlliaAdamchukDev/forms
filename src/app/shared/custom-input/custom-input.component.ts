import { Component, forwardRef, Input, ViewChild, ElementRef, Renderer2, HostListener } from '@angular/core';
...
export class CustomInputComponent implements ControlValueAccessor, Validator{
  ...
  @ViewChild('element',{static:true, read: ElementRef}) elementRef !: ElementRef;
